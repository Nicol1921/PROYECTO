...
# Definición de la ruta '/venta' para la página de inicio de venta.
@app.route('/venta')
def inicio():
    return render_template('public/Venta.html')  # Renderiza la plantilla 'public/Venta.html'

# Definición de la ruta '/form' para el registro de ventas.
...
def registrarVenta():
    ...
    if request.method == 'POST':
        ...
        idPreVenta = request.form['idPreVenta']
        ...
        # Prepara y ejecuta la consulta SQL para insertar datos en la tabla 'Venta'.
        sql = ("INSERT INTO Venta(idPrenda, idPreVenta, fecha, codigo, estado) VALUES (%s, %s, %s, %s, %s)")
        valores = (idPrenda, idPreVenta, fecha, codigo, estado)
        ...
        return render_template('public/Venta.html', msg='Formulario enviado')
    else:
        return render_template('public/Venta.html', msg='Método HTTP incorrecto')
