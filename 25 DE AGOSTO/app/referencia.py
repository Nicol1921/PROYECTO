...
# Definición de la ruta '/referencia' para la página de inicio de referencia.
@app.route('/referencia')
def inicio():
    return render_template('public/Referencia.html')  # Renderiza la plantilla 'public/Referencia.html'

# Definición de la ruta '/form' para el registro de referencias.
@app.route('/form', methods=['GET', 'POST'])
def registrarReferencia():
    ...
    if request.method == 'POST':
        ...
        # Prepara y ejecuta la consulta SQL para insertar datos en la tabla 'Referencia'.
        sql = ("INSERT INTO Referencia(idReferencia, nombre, descripcion, referencia) VALUES (%s, %s, %s, %s)")
        valores = (idReferencia, nombre, descripcion, referencia)
        ...
        return render_template('public/Referencia.html', msg='Formulario enviado')
    else:
        return render_template('public/Referencia.html', msg='Método HTTP incorrecto')
